...
7. 시스템 사용자 관리
   - 사용자 : `uesradd`, `usermod`, `userdel`, `passwd`, `su`
...
## ~~3.1. GitHub 활용법~~
### 3.2.1. 로컬 레포지토리에서 작업
> <ins/>원격 레포지토리가 GitHub에 생성되어 있음을 가정</ins>
```shell
...
develop
* main
opensw@tux:~/gitlab/openswproject$ git log --online --decorate --graph -all
